...
(defn listar-using-get8-with-http-info
  ...
  ([id-conta confirmacao-fraude ] (listar-using-get8-with-http-info id-conta confirmacao-fraude nil))
...
(defn listar-using-get8
  "Listar as transa̵̤es com resolṳ̣o de risco fraude pendente
  Este recurso permite que sejam listados os riscos de fraudes existentes"
  ([id-conta confirmacao-fraude ] (listar-using-get8 id-conta confirmacao-fraude nil))
  ([id-conta confirmacao-fraude optional-params]
   (:data (listar-using-get8-with-http-info id-conta confirmacao-fraude optional-params))))
