...
(defn alterar-using-put18-with-http-info
  ...
  ([id tipo-evento url ] (alterar-using-put18-with-http-info id tipo-evento url nil))
...
(defn alterar-using-put18
  "Alterar Webhook
  Este mÃ©todo permite que seja modificado um webhooks jÃ¡ cadastrado"
  ([id tipo-evento url ] (alterar-using-put18 id tipo-evento url nil))
  ([id tipo-evento url optional-params]
   (:data (alterar-using-put18-with-http-info id tipo-evento url optional-params))))
...
(defn salvar-using-post25
  ...
  Este mÃ©todo permite que seja adicionado um novo webhook"
  [tipo-evento url ]
  (:data (salvar-using-post25-with-http-info tipo-evento url)))
