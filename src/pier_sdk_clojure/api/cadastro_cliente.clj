...
(defn salvar-using-post14-with-http-info
  ...
  ([nome tipo data-nascimento ] (salvar-using-post14-with-http-info nome tipo data-nascimento nil))
...
(defn salvar-using-post14
  "Realiza o cadastro de um nova Pessoa
  Este m̩todo permite que seja cadastrado uma nova Pessoa na base de dados do Emissor."
  ([nome tipo data-nascimento ] (salvar-using-post14 nome tipo data-nascimento nil))
  ([nome tipo data-nascimento optional-params]
   (:data (salvar-using-post14-with-http-info nome tipo data-nascimento optional-params))))
