...
(defn alterar-using-put13-with-http-info
  ...
  ([id ] (alterar-using-put13-with-http-info id nil))
...
(defn alterar-using-put13
  "Atualiza os detalhes de uma determinada Pessoa
  Este m̩todo permite que seja alterado na base do emissor os detalhes de uma determinada Pessoa."
  ([id ] (alterar-using-put13 id nil))
  ([id optional-params]
   (:data (alterar-using-put13-with-http-info id optional-params))))

(defn alterar-using-put14-with-http-info
  "Atualiza os dados de uma determinada Pessoa
  Este m̩todo permite que seja alterado na base do emissor um registro de determinada Pessoa."
  ([id nome tipo data-nascimento ] (alterar-using-put14-with-http-info id nome tipo data-nascimento nil))
...
(defn alterar-using-put14
  "Atualiza os dados de uma determinada Pessoa
  Este m̩todo permite que seja alterado na base do emissor um registro de determinada Pessoa."
  ([id nome tipo data-nascimento ] (alterar-using-put14 id nome tipo data-nascimento nil))
  ([id nome tipo data-nascimento optional-params]
   (:data (alterar-using-put14-with-http-info id nome tipo data-nascimento optional-params))))

(defn alterar-using-put16-with-http-info
  "Realiza a altera̤̣o de um determinado Telefone
  Este m̩todo permite que seja alterado um determinado Telefone na base de dados do Emissor."
  ([id ] (alterar-using-put16-with-http-info id nil))
...
(defn alterar-using-put16
  "Realiza a altera̤̣o de um determinado Telefone
  Este m̩todo permite que seja alterado um determinado Telefone na base de dados do Emissor."
  ([id ] (alterar-using-put16 id nil))
  ([id optional-params]
   (:data (alterar-using-put16-with-http-info id optional-params))))
...
(defn salvar-using-post14-with-http-info
  ...
  ([id ] (salvar-using-post14-with-http-info id nil))
  ([id {:keys [body ]}]
...
(defn salvar-using-post14
  "Inclui a conta como registro para integra̤̣o
  Este recurso permite incluir uma conta como registro para integra̤̣o."
  ([id ] (salvar-using-post14 id nil))
  ([id optional-params]
   (:data (salvar-using-post14-with-http-info id optional-params))))

(defn salvar-using-post19-with-http-info
  "Salvar os detalhes de uma determinada Pessoa
  Este m̩todo permite que seja incluido na base do emissor os detalhes de uma determinada Pessoa."
  ([id-pessoa ] (salvar-using-post19-with-http-info id-pessoa nil))
...
(defn salvar-using-post19
  "Salvar os detalhes de uma determinada Pessoa
  Este m̩todo permite que seja incluido na base do emissor os detalhes de uma determinada Pessoa."
  ([id-pessoa ] (salvar-using-post19 id-pessoa nil))
  ([id-pessoa optional-params]
   (:data (salvar-using-post19-with-http-info id-pessoa optional-params))))

(defn salvar-using-post20-with-http-info
  "Realiza o cadastro de um nova Pessoa
  Este m̩todo permite que seja cadastrado uma nova Pessoa na base de dados do Emissor."
  ([nome tipo data-nascimento ] (salvar-using-post20-with-http-info nome tipo data-nascimento nil))
...
(defn salvar-using-post20
  "Realiza o cadastro de um nova Pessoa
  Este m̩todo permite que seja cadastrado uma nova Pessoa na base de dados do Emissor."
  ([nome tipo data-nascimento ] (salvar-using-post20 nome tipo data-nascimento nil))
  ([nome tipo data-nascimento optional-params]
   (:data (salvar-using-post20-with-http-info nome tipo data-nascimento optional-params))))

(defn salvar-using-post23-with-http-info
  "Realiza o cadastro de um novo Telefone
  Este m̩todo permite que seja cadastrado um novo Telefone na base de dados do Emissor."
  ([] (salvar-using-post23-with-http-info nil))
...
(defn salvar-using-post23
  "Realiza o cadastro de um novo Telefone
  Este m̩todo permite que seja cadastrado um novo Telefone na base de dados do Emissor."
  ([] (salvar-using-post23 nil))
  ([optional-params]
   (:data (salvar-using-post23-with-http-info optional-params))))
