...
(defn alterar-using-put6-with-http-info
  ...
  ([id nome tipo data-nascimento ] (alterar-using-put6-with-http-info id nome tipo data-nascimento nil))
...
(defn alterar-using-put6
  "Atualiza os dados de uma determinada Pessoa
  Este m̩todo permite que seja alterado na base do emissor um registro de determinada Pessoa."
  ([id nome tipo data-nascimento ] (alterar-using-put6 id nome tipo data-nascimento nil))
  ([id nome tipo data-nascimento optional-params]
   (:data (alterar-using-put6-with-http-info id nome tipo data-nascimento optional-params))))
...
(defn salvar-using-post12-with-http-info
  ...
  ([id-pessoa ] (salvar-using-post12-with-http-info id-pessoa nil))
...
(defn salvar-using-post12
  "Salvar os detalhes de uma determinada Pessoa
  Este m̩todo permite que seja incluido na base do emissor os detalhes de uma determinada Pessoa."
  ([id-pessoa ] (salvar-using-post12 id-pessoa nil))
  ([id-pessoa optional-params]
   (:data (salvar-using-post12-with-http-info id-pessoa optional-params))))

(defn salvar-using-post13-with-http-info
  "Realiza o cadastro de um nova Pessoa
  Este m̩todo permite que seja cadastrado uma nova Pessoa na base de dados do Emissor."
  ([nome tipo data-nascimento ] (salvar-using-post13-with-http-info nome tipo data-nascimento nil))
...
(defn salvar-using-post13
  "Realiza o cadastro de um nova Pessoa
  Este m̩todo permite que seja cadastrado uma nova Pessoa na base de dados do Emissor."
  ([nome tipo data-nascimento ] (salvar-using-post13 nome tipo data-nascimento nil))
  ([nome tipo data-nascimento optional-params]
   (:data (salvar-using-post13-with-http-info nome tipo data-nascimento optional-params))))

(defn salvar-using-post15-with-http-info
  "Realiza o cadastro de um novo Telefone
  Este m̩todo permite que seja cadastrado um novo Telefone na base de dados do Emissor."
  ([] (salvar-using-post15-with-http-info nil))
...
(defn salvar-using-post15
  "Realiza o cadastro de um novo Telefone
  Este m̩todo permite que seja cadastrado um novo Telefone na base de dados do Emissor."
  ([] (salvar-using-post15 nil))
  ([optional-params]
   (:data (salvar-using-post15-with-http-info optional-params))))
...
(defn salvar-using-post9-with-http-info
  ...
  ([id ] (salvar-using-post9-with-http-info id nil))
  ([id {:keys [body ]}]
...
(defn salvar-using-post9
  "Inclui a conta como registro para integra̤̣o
  Este recurso permite incluir uma conta como registro para integra̤̣o."
  ([id ] (salvar-using-post9 id nil))
  ([id optional-params]
   (:data (salvar-using-post9-with-http-info id optional-params))))
